...
```
/Users/nancyangulo$/Desktop/IMG_0264.jpeg
...
`c(1, 2, 3, "Hi") + 1 `
# no because they are characters

#How about 

`c(1, 2, 3, FALSE) + 1 `
# Yes because there are numerics
...
qplot( x_axis, 
      ...
      xlab = "cool x_axis",
      ylab = "cooler y_axis",
      main = "My really cool plot of x_axis versus y_axis")
